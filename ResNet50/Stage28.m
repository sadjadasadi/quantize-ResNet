...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage27.mat');
shortcutInput= load('InputOutput\OutputStage25.mat');
WeightBias = load('WeightsBias\WeightBias28.mat');
...
OutputErrStage27     = Input.OutputErrReLU2;
InstinctErrStage27   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage28Weights;
fxpWeights = WeightBias.fxpStage28Weights;
flpBias    = WeightBias.flpStage28Bias;
fxpBias    = WeightBias.fxpStage28Bias;
errWeights = WeightBias.errStage28Weights;
...
save('InputOutput\OutputStage28','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
