...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage23.mat');
WeightBias = load('WeightsBias\WeightBias24.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage23     = Input.OutputErrReLU2;
InstinctErrStage23   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage24Weights;
fxpWeights = WeightBias.fxpStage24Weights;
flpBias    = WeightBias.flpStage24Bias;
fxpBias    = WeightBias.fxpStage24Bias;
errWeights = WeightBias.errStage24Weights;
...
save('InputOutput\OutputStage24','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
