...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage33.mat');
shortcutInput= load('InputOutput\OutputStage31.mat');
WeightBias = load('WeightsBias\WeightBias34.mat');
...
OutputErrStage33     = Input.OutputErrReLU2;
InstinctErrStage33   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage34Weights;
fxpWeights = WeightBias.fxpStage34Weights;
flpBias    = WeightBias.flpStage34Bias;
fxpBias    = WeightBias.fxpStage34Bias;
errWeights = WeightBias.errStage34Weights;
...
save('InputOutput\OutputStage34','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
