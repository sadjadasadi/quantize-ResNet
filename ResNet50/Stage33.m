...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage32.mat');
WeightBias = load('WeightsBias\WeightBias33.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage32     = Input.OutputErrReLU2;
InstinctErrStage32   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage33Weights;
fxpWeights = WeightBias.fxpStage33Weights;
flpBias    = WeightBias.flpStage33Bias;
fxpBias    = WeightBias.fxpStage33Bias;
errWeights = WeightBias.errStage33Weights;
...
save('InputOutput\OutputStage33','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
