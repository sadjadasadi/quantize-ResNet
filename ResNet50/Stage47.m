...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage46.mat');
WeightBias = load('WeightsBias\WeightBias47.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage46    = Input.OutputErrReLU2;
InstinctErrStage46  = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage47Weights;
fxpWeights = WeightBias.fxpStage47Weights;
flpBias    = WeightBias.flpStage47Bias;
fxpBias    = WeightBias.fxpStage47Bias;
errWeights = WeightBias.errStage47Weights;
...
save('InputOutput\OutputStage47','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
