...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage28.mat');
WeightBias = load('WeightsBias\WeightBias29.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage28     = Input.OutputErrReLU2;
InstinctErrStage28   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage29Weights;
fxpWeights = WeightBias.fxpStage29Weights;
flpBias    = WeightBias.flpStage29Bias;
fxpBias    = WeightBias.fxpStage29Bias;
errWeights = WeightBias.errStage29Weights;
...
save('InputOutput\OutputStage29','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
