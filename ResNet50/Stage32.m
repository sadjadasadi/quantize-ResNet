...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage31.mat');
WeightBias = load('WeightsBias\WeightBias32.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage31     = Input.OutputErrReLU2;
InstinctErrStage31   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage32Weights;
fxpWeights = WeightBias.fxpStage32Weights;
flpBias    = WeightBias.flpStage32Bias;
fxpBias    = WeightBias.fxpStage32Bias;
errWeights = WeightBias.errStage32Weights;
...
save('InputOutput\OutputStage32','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
