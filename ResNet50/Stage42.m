...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage41.mat');
WeightBias = load('WeightsBias\WeightBias42.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage41     = Input.OutputErrReLU2;
InstinctErrStage41   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage42Weights;
fxpWeights = WeightBias.fxpStage42Weights;
flpBias    = WeightBias.flpStage42Bias;
fxpBias    = WeightBias.fxpStage42Bias;
errWeights = WeightBias.errStage42Weights;
...
save('InputOutput\OutputStage42','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
