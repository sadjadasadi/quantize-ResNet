...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage22.mat');
WeightBias = load('WeightsBias\WeightBias23.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage22     = Input.OutputErrReLU2;
InstinctErrStage22   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage23Weights;
fxpWeights = WeightBias.fxpStage23Weights;
flpBias    = WeightBias.flpStage23Bias;
fxpBias    = WeightBias.fxpStage23Bias;
errWeights = WeightBias.errStage23Weights;
...
save('InputOutput\OutputStage23','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
