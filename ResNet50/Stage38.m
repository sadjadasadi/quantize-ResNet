...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage37.mat');
WeightBias = load('WeightsBias\WeightBias38.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage37     = Input.OutputErrReLU2;
InstinctErrStage37   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage38Weights;
fxpWeights = WeightBias.fxpStage38Weights;
flpBias    = WeightBias.flpStage38Bias;
fxpBias    = WeightBias.fxpStage38Bias;
errWeights = WeightBias.errStage38Weights;
...
save('InputOutput\OutputStage38','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
