...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage35.mat');
WeightBias = load('WeightsBias\WeightBias36.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage35     = Input.OutputErrReLU2;
InstinctErrStage35   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage36Weights;
fxpWeights = WeightBias.fxpStage36Weights;
flpBias    = WeightBias.flpStage36Bias;
fxpBias    = WeightBias.fxpStage36Bias;
errWeights = WeightBias.errStage36Weights;
...
save('InputOutput\OutputStage36','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
