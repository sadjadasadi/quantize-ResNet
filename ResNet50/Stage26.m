...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage25.mat');
WeightBias = load('WeightsBias\WeightBias26.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage25     = Input.OutputErrReLU2;
InstinctErrStage25   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage26Weights;
fxpWeights = WeightBias.fxpStage26Weights;
flpBias    = WeightBias.flpStage26Bias;
fxpBias    = WeightBias.fxpStage26Bias;
errWeights = WeightBias.errStage26Weights;
...
save('InputOutput\OutputStage26','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
