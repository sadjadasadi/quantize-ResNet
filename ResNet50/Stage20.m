...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage19.mat');
WeightBias = load('WeightsBias\WeightBias20.mat');
...
flpWeights = WeightBias.flpStage20Weights;
fxpWeights = WeightBias.fxpStage20Weights;
flpBias    = WeightBias.flpStage20Bias;
fxpBias    = WeightBias.fxpStage20Bias;
errWeights = WeightBias.errStage20Weights;
...
save('InputOutput\OutputStage20','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
