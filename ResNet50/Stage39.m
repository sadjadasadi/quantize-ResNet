...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage38.mat');
WeightBias = load('WeightsBias\WeightBias39.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage38     = Input.OutputErrReLU2;
InstinctErrStage38   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage39Weights;
fxpWeights = WeightBias.fxpStage39Weights;
flpBias    = WeightBias.flpStage39Bias;
fxpBias    = WeightBias.fxpStage39Bias;
errWeights = WeightBias.errStage39Weights;
...
save('InputOutput\OutputStage39','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
