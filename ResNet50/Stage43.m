...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage42.mat');
shortcutInput= load('InputOutput\OutputStage40.mat');
WeightBias = load('WeightsBias\WeightBias43.mat');
...
OutputErrStage42     = Input.OutputErrReLU2;
InstinctErrStage42   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage43Weights;
fxpWeights = WeightBias.fxpStage43Weights;
flpBias    = WeightBias.flpStage43Bias;
fxpBias    = WeightBias.fxpStage43Bias;
errWeights = WeightBias.errStage43Weights;
...
save('InputOutput\OutputStage43','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
