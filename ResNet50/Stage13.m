...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage12.mat');
shortcutInput= load('InputOutput\OutputStage10.mat');
WeightBias = load('WeightsBias\WeightBias13.mat');
...
OutputErrStage12     = Input.OutputErrReLU2;
InstinctErrStage12   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage13Weights;
fxpWeights = WeightBias.fxpStage13Weights;
flpBias    = WeightBias.flpStage13Bias;
fxpBias    = WeightBias.fxpStage13Bias;
errWeights = WeightBias.errStage13Weights;
...
save('InputOutput\OutputStage13','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
