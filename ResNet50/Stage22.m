...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage21.mat');
shortcutInput= load('InputOutput\OutputStage19.mat');
WeightBias = load('WeightsBias\WeightBias22.mat');
...
OutputErrStage19     = Input.OutputErrReLU2;
InstinctErrStage19   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage22Weights;
fxpWeights = WeightBias.fxpStage22Weights;
flpBias    = WeightBias.flpStage22Bias;
fxpBias    = WeightBias.fxpStage22Bias;
errWeights = WeightBias.errStage22Weights;
...
save('InputOutput\OutputStage22','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
