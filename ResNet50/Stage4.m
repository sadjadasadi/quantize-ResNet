...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage3.mat');
shortcutInput= load('InputOutput\OutputStage1.mat');
WeightBias = load('WeightsBias\WeightBias4.mat');

shortcutflpInput    = shortcutInput.flpOutput; 
shortcutfxpInput    = shortcutInput.fxpOutput2;
shortcutflpfxpInput = shortcutInput.flpfxpOutput;

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage3     = Input.OutputErrReLU2;
InstinctErrStage3   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage4Weights;
fxpWeights = WeightBias.fxpStage4Weights;
flpBias    = WeightBias.flpStage4Bias;
fxpBias    = WeightBias.fxpStage4Bias;
errWeights = WeightBias.errStage4Weights;
...
%% adder ------------------------------------------------------------------
shortcutflpInput2       = zeros(Noy,Nox,Nof);
shortcutfxpInput2       = zeros(Noy,Nox,Nof);
shortcutflpfxpInput2    = zeros(Noy,Nox,Nof);

shortcutflpInput2(:,:,1:Nof/4)      = shortcutflpInput;
shortcutfxpInput2(:,:,1:Nof/4)      = shortcutfxpInput;
shortcutflpfxpInput2(:,:,1:Nof/4)   = shortcutflpfxpInput;

flpOutputAdder           = shortcutflpInput2 + flpOutputDSP;
fxpOutputAdder           = shortcutfxpInput2 + fxpOutputDSP;
flpfxpfxpOutputAdder     = shortcutflpfxpInput2 + flpfxpfxpOutputDSP;
flpfxpOutputAdder        = shortcutflpInput2 + flpfxpOutputDSP;
...
save('InputOutput\OutputStage4','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
