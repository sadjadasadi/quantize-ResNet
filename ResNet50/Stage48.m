...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage47.mat');
WeightBias = load('WeightsBias\WeightBias48.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage47     = Input.OutputErrReLU2;
InstinctErrStage47   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage48Weights;
fxpWeights = WeightBias.fxpStage48Weights;
flpBias    = WeightBias.flpStage48Bias;
fxpBias    = WeightBias.fxpStage48Bias;
errWeights = WeightBias.errStage48Weights;
...
save('InputOutput\OutputStage48','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
