...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage6.mat');
shortcutInput= load('InputOutput\OutputStage5.mat');
WeightBias = load('WeightsBias\WeightBias7.mat');
...
OutputErrStage6 = Input.OutputErrReLU2;
InstinctErrStage6 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage7Weights;
fxpWeights = WeightBias.fxpStage7Weights;
flpBias    = WeightBias.flpStage7Bias;
fxpBias    = WeightBias.fxpStage7Bias;
errWeights = WeightBias.errStage7Weights;
...
save('InputOutput\OutputStage7','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage7xlxErr.xlsx";
...
filename = "excel/MaxMinStage7.xlsx";
