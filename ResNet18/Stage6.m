...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage5.mat');
WeightBias = load('WeightsBias\WeightBias6.mat');

flpInput    = Input.flpOutputReLU; 
fxpInput    = Input.fxpOutputReLU2;
flpfxpInput = Input.flpfxpfxpOutputReLU;
OutputErrStage5 = Input.OutputErrReLU2;
InstinctErrStage5 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage6Weights;
fxpWeights = WeightBias.fxpStage6Weights;
flpBias    = WeightBias.flpStage6Bias;
fxpBias    = WeightBias.fxpStage6Bias;
errWeights = WeightBias.errStage6Weights;
...
save('InputOutput\OutputStage6','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage6xlxErr.xlsx";
...
filename = "excel/MaxMinStage6.xlsx";
