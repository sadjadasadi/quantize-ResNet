...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage13.mat');
WeightBias = load('WeightsBias\WeightBias14.mat');

flpInput    = Input.flpOutputReLU; 
fxpInput    = Input.fxpOutputReLU2;
flpfxpInput = Input.flpfxpfxpOutputReLU;
OutputErrStage13 = Input.OutputErrReLU2;
InstinctErrStage13 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage14Weights;
fxpWeights = WeightBias.fxpStage14Weights;
flpBias    = WeightBias.flpStage14Bias;
fxpBias    = WeightBias.fxpStage14Bias;
errWeights = WeightBias.errStage14Weights;
...
save('InputOutput\OutputStage14','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage14xlxErr.xlsx";
writematrix(xlxErr,filename);

MaxMin = [maxflpOutputDSP minflpOutputDSP];
filename = "excel/MaxMinStage14.xlsx";
