...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage2.mat');
shortcutInput= load('InputOutput\OutputStage1.mat');
WeightBias = load('WeightsBias\WeightBias3.mat');
...
OutputErrStage2 = Input.OutputErrReLU2;
InstinctErrStage2 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage3Weights;
fxpWeights = WeightBias.fxpStage3Weights;
flpBias    = WeightBias.flpStage3Bias;
fxpBias    = WeightBias.fxpStage3Bias;
errWeights = WeightBias.errStage3Weights;
...
save('InputOutput\OutputStage3','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage3xlxErr.xlsx";
...
filename = "excel/MaxMinStage3.xlsx";
