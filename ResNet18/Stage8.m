...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage7.mat');
WeightBias = load('WeightsBias\WeightBias8.mat');

flpInput    = Input.flpOutputReLU; 
fxpInput    = Input.fxpOutputReLU2;
flpfxpInput = Input.flpfxpfxpOutputReLU;
OutputErrStage7 = Input.OutputErrReLU2;
InstinctErrStage7 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage8Weights;
fxpWeights = WeightBias.fxpStage8Weights;
flpBias    = WeightBias.flpStage8Bias;
fxpBias    = WeightBias.fxpStage8Bias;
errWeights = WeightBias.errStage8Weights;
...
save('InputOutput\OutputStage8','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
