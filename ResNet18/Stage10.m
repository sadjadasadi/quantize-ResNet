...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage9.mat');
WeightBias = load('WeightsBias\WeightBias10.mat');

flpInput    = Input.flpOutputReLU; 
fxpInput    = Input.fxpOutputReLU2;
flpfxpInput = Input.flpfxpfxpOutputReLU;
OutputErrStage9 = Input.OutputErrReLU2;
InstinctErrStage9 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage10Weights;
fxpWeights = WeightBias.fxpStage10Weights;
flpBias    = WeightBias.flpStage10Bias;
fxpBias    = WeightBias.fxpStage10Bias;
errWeights = WeightBias.errStage10Weights;
...
save('InputOutput\OutputStage10','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage10xlxErr.xlsx";
writematrix(xlxErr,filename);


MaxMin = [maxflpOutputDSP minflpOutputDSP];
filename = "excel/MaxMinStage10.xlsx";
