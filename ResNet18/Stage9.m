...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage8.mat');
shortcutInput= load('InputOutput\OutputStage7.mat');
WeightBias = load('WeightsBias\WeightBias9.mat');
...
OutputErrStage8 = Input.OutputErrReLU2;
InstinctErrStage8 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage9Weights;
fxpWeights = WeightBias.fxpStage9Weights;
flpBias    = WeightBias.flpStage9Bias;
fxpBias    = WeightBias.fxpStage9Bias;
errWeights = WeightBias.errStage9Weights;
...
save('InputOutput\OutputStage9','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage9xlxErr.xlsx";
...
filename = "excel/MaxMinStage9.xlsx";
