...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage16.mat');
shortcutInput= load('InputOutput\OutputStage15.mat');
WeightBias = load('WeightsBias\WeightBias17.mat');
...
OutputErrStage16 = Input.OutputErrReLU2;
InstinctErrStage16 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage17Weights;
fxpWeights = WeightBias.fxpStage17Weights;
flpBias    = WeightBias.flpStage17Bias;
fxpBias    = WeightBias.fxpStage17Bias;
errWeights = WeightBias.errStage17Weights;
...
save('InputOutput\OutputStage17','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage17xlxErr.xlsx";
...
filename = "excel/MaxMinStage17.xlsx";
