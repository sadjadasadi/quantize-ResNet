...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage11.mat');
WeightBias = load('WeightsBias\WeightBias12.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage11    = Input.OutputErrReLU2;
InstinctErrStage11  = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage12Weights;
fxpWeights = WeightBias.fxpStage12Weights;
flpBias    = WeightBias.flpStage12Bias;
fxpBias    = WeightBias.fxpStage12Bias;
errWeights = WeightBias.errStage12Weights;
...
save('InputOutput\OutputStage12','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage12xlxErr.xlsx";
writematrix(xlxErr,filename);

MaxMin = [maxflpOutputDSP minflpOutputDSP];
filename = "excel/MaxMinStage12.xlsx";
