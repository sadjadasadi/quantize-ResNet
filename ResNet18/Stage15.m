...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage14.mat');
shortcutInput= load('InputOutput\OutputStage13.mat');
WeightBias = load('WeightsBias\WeightBias15.mat');
...
OutputErrStage14 = Input.OutputErrReLU2;
InstinctErrStage14 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage15Weights;
fxpWeights = WeightBias.fxpStage15Weights;
flpBias    = WeightBias.flpStage15Bias;
fxpBias    = WeightBias.fxpStage15Bias;
errWeights = WeightBias.errStage15Weights;
...
shortcutflpInput2(:,:,1:Nof/2)      = shortcutflpInput(1:2:end ,1:2:end,:);
shortcutfxpInput2(:,:,1:Nof/2)      = shortcutfxpInput(1:2:end ,1:2:end,:);
shortcutflpfxpInput2(:,:,1:Nof/2)   = shortcutflpfxpInput(1:2:end ,1:2:end,:);
...
save('InputOutput\OutputStage15','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage15xlxErr.xlsx";
...
filename = "excel/MaxMinStage15.xlsx";
