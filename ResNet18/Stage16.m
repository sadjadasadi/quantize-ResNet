...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage15.mat');
WeightBias = load('WeightsBias\WeightBias16.mat');

flpInput    = Input.flpOutputReLU; 
fxpInput    = Input.fxpOutputReLU2;
flpfxpInput = Input.flpfxpfxpOutputReLU;
OutputErrStage15 = Input.OutputErrReLU2;
InstinctErrStage15 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage16Weights;
fxpWeights = WeightBias.fxpStage16Weights;
flpBias    = WeightBias.flpStage16Bias;
fxpBias    = WeightBias.fxpStage16Bias;
errWeights = WeightBias.errStage16Weights;
...
save('InputOutput\OutputStage16','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage16xlxErr.xlsx";
writematrix(xlxErr,filename);

MaxMin = [maxflpOutputDSP minflpOutputDSP];
filename = "excel/MaxMinStage16.xlsx";
