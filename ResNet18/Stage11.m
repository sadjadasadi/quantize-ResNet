...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage10.mat');
shortcutInput= load('InputOutput\OutputStage9.mat');
WeightBias = load('WeightsBias\WeightBias11.mat');
...
OutputErrStage10 = Input.OutputErrReLU2;
InstinctErrStage10 = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage11Weights;
fxpWeights = WeightBias.fxpStage11Weights;
flpBias    = WeightBias.flpStage11Bias;
fxpBias    = WeightBias.fxpStage11Bias;
errWeights = WeightBias.errStage11Weights;
...
save('InputOutput\OutputStage11','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
...
filename = "excel/Stage11xlxErr.xlsx";
...
filename = "excel/MaxMinStage11.xlsx";
