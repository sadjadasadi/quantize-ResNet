...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage83.mat');
WeightBias = load('WeightsBias\WeightBias84.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage83     = Input.OutputErrReLU2;
InstinctErrStage83   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage84Weights;
fxpWeights = WeightBias.fxpStage84Weights;
flpBias    = WeightBias.flpStage84Bias;
fxpBias    = WeightBias.fxpStage84Bias;
errWeights = WeightBias.errStage84Weights;
...
save('InputOutput\OutputStage84','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
