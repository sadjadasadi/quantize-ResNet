...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage20.mat');
WeightBias = load('WeightsBias\WeightBias21.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage20     = Input.OutputErrReLU2;
InstinctErrStage20   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage21Weights;
fxpWeights = WeightBias.fxpStage21Weights;
flpBias    = WeightBias.flpStage21Bias;
fxpBias    = WeightBias.fxpStage21Bias;
errWeights = WeightBias.errStage21Weights;
...
save('InputOutput\OutputStage21','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
