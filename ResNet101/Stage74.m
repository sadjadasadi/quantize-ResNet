...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage73.mat');
WeightBias = load('WeightsBias\WeightBias74.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage73     = Input.OutputErrReLU2;
InstinctErrStage73   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage74Weights;
fxpWeights = WeightBias.fxpStage74Weights;
flpBias    = WeightBias.flpStage74Bias;
fxpBias    = WeightBias.fxpStage74Bias;
errWeights = WeightBias.errStage74Weights;
...
save('InputOutput\OutputStage74','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
