...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage58.mat');
WeightBias = load('WeightsBias\WeightBias59.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage58     = Input.OutputErrReLU2;
InstinctErrStage58   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage59Weights;
fxpWeights = WeightBias.fxpStage59Weights;
flpBias    = WeightBias.flpStage59Bias;
fxpBias    = WeightBias.fxpStage59Bias;
errWeights = WeightBias.errStage59Weights;
...
save('InputOutput\OutputStage59','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
