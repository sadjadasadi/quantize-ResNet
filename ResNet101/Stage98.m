...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage97.mat');
WeightBias = load('WeightsBias\WeightBias98.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage97    = Input.OutputErrReLU2;
InstinctErrStage97  = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage98Weights;
fxpWeights = WeightBias.fxpStage98Weights;
flpBias    = WeightBias.flpStage98Bias;
fxpBias    = WeightBias.fxpStage98Bias;
errWeights = WeightBias.errStage98Weights;
...
save('InputOutput\OutputStage98','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
