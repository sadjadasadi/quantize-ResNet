...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage86.mat');
WeightBias = load('WeightsBias\WeightBias87.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage86     = Input.OutputErrReLU2;
InstinctErrStage86   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage87Weights;
fxpWeights = WeightBias.fxpStage87Weights;
flpBias    = WeightBias.flpStage87Bias;
fxpBias    = WeightBias.fxpStage87Bias;
errWeights = WeightBias.errStage87Weights;
...
save('InputOutput\OutputStage87','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
