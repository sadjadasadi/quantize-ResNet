...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage99.mat');
shortcutInput= load('InputOutput\OutputStage97.mat');
WeightBias = load('WeightsBias\WeightBias100.mat');
...
OutputErrStage99     = Input.OutputErrReLU2;
InstinctErrStage99   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage100Weights;
fxpWeights = WeightBias.fxpStage100Weights;
flpBias    = WeightBias.flpStage100Bias;
fxpBias    = WeightBias.fxpStage100Bias;
errWeights = WeightBias.errStage100Weights;
...
save('InputOutput\OutputStage100','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
