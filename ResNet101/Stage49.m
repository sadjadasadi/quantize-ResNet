...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage48.mat');
shortcutInput= load('InputOutput\OutputStage46.mat');
WeightBias = load('WeightsBias\WeightBias49.mat');
...
OutputErrStage48     = Input.OutputErrReLU2;
InstinctErrStage48   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage49Weights;
fxpWeights = WeightBias.fxpStage49Weights;
flpBias    = WeightBias.flpStage49Bias;
fxpBias    = WeightBias.fxpStage49Bias;
errWeights = WeightBias.errStage49Weights;
...
save('InputOutput\OutputStage49','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
