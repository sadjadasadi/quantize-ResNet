...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage85.mat');
WeightBias = load('WeightsBias\WeightBias86.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage85     = Input.OutputErrReLU2;
InstinctErrStage85   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage86Weights;
fxpWeights = WeightBias.fxpStage86Weights;
flpBias    = WeightBias.flpStage86Bias;
fxpBias    = WeightBias.fxpStage86Bias;
errWeights = WeightBias.errStage86Weights;
...
save('InputOutput\OutputStage86','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
