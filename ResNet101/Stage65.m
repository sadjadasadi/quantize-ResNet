...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage64.mat');
WeightBias = load('WeightsBias\WeightBias65.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage64     = Input.OutputErrReLU2;
InstinctErrStage64   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage65Weights;
fxpWeights = WeightBias.fxpStage65Weights;
flpBias    = WeightBias.flpStage65Bias;
fxpBias    = WeightBias.fxpStage65Bias;
errWeights = WeightBias.errStage65Weights;
...
save('InputOutput\OutputStage65','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
