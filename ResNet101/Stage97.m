...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage96.mat');
shortcutInput= load('InputOutput\OutputStage94.mat');
WeightBias = load('WeightsBias\WeightBias97.mat');
...
OutputErrStage96     = Input.OutputErrReLU2;
InstinctErrStage96   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage97Weights;
fxpWeights = WeightBias.fxpStage97Weights;
flpBias    = WeightBias.flpStage97Bias;
fxpBias    = WeightBias.fxpStage97Bias;
errWeights = WeightBias.errStage97Weights;
...
save('InputOutput\OutputStage97','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
