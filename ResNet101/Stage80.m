...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage79.mat');
WeightBias = load('WeightsBias\WeightBias80.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage79     = Input.OutputErrReLU2;
InstinctErrStage79   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage80Weights;
fxpWeights = WeightBias.fxpStage80Weights;
flpBias    = WeightBias.flpStage80Bias;
fxpBias    = WeightBias.fxpStage80Bias;
errWeights = WeightBias.errStage80Weights;
...
save('InputOutput\OutputStage80','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
