...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage36.mat');
shortcutInput= load('InputOutput\OutputStage34.mat');
WeightBias = load('WeightsBias\WeightBias37.mat');
...
OutputErrStage36     = Input.OutputErrReLU2;
InstinctErrStage36   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage37Weights;
fxpWeights = WeightBias.fxpStage37Weights;
flpBias    = WeightBias.flpStage37Bias;
fxpBias    = WeightBias.fxpStage37Bias;
errWeights = WeightBias.errStage37Weights;
...
save('InputOutput\OutputStage37','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
