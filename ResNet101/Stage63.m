...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage62.mat');
WeightBias = load('WeightsBias\WeightBias63.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage62     = Input.OutputErrReLU2;
InstinctErrStage62   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage63Weights;
fxpWeights = WeightBias.fxpStage63Weights;
flpBias    = WeightBias.flpStage63Bias;
fxpBias    = WeightBias.fxpStage63Bias;
errWeights = WeightBias.errStage63Weights;
...
save('InputOutput\OutputStage63','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
