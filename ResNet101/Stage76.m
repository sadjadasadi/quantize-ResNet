...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage75.mat');
shortcutInput= load('InputOutput\OutputStage73.mat');
WeightBias = load('WeightsBias\WeightBias76.mat');
...
OutputErrStage75     = Input.OutputErrReLU2;
InstinctErrStage75   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage76Weights;
fxpWeights = WeightBias.fxpStage76Weights;
flpBias    = WeightBias.flpStage76Bias;
fxpBias    = WeightBias.fxpStage76Bias;
errWeights = WeightBias.errStage76Weights;
...
save('InputOutput\OutputStage76','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
