...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage68.mat');
WeightBias = load('WeightsBias\WeightBias69.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage68     = Input.OutputErrReLU2;
InstinctErrStage68   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage69Weights;
fxpWeights = WeightBias.fxpStage69Weights;
flpBias    = WeightBias.flpStage69Bias;
fxpBias    = WeightBias.fxpStage69Bias;
errWeights = WeightBias.errStage69Weights;
...
save('InputOutput\OutputStage69','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
