...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage51.mat');
shortcutInput= load('InputOutput\OutputStage49.mat');
WeightBias = load('WeightsBias\WeightBias52.mat');
...
OutputErrStage51     = Input.OutputErrReLU2;
InstinctErrStage51   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage52Weights;
fxpWeights = WeightBias.fxpStage52Weights;
flpBias    = WeightBias.flpStage52Bias;
fxpBias    = WeightBias.fxpStage52Bias;
errWeights = WeightBias.errStage52Weights;
...
save('InputOutput\OutputStage52','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
