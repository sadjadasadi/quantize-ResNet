...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage63.mat');
shortcutInput= load('InputOutput\OutputStage61.mat');
WeightBias = load('WeightsBias\WeightBias64.mat');
...
OutputErrStage63     = Input.OutputErrReLU2;
InstinctErrStage63   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage64Weights;
fxpWeights = WeightBias.fxpStage64Weights;
flpBias    = WeightBias.flpStage64Bias;
fxpBias    = WeightBias.fxpStage64Bias;
errWeights = WeightBias.errStage64Weights;
...
save('InputOutput\OutputStage64','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
