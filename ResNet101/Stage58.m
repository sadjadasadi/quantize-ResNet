...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage57.mat');
shortcutInput= load('InputOutput\OutputStage55.mat');
WeightBias = load('WeightsBias\WeightBias58.mat');
...
OutputErrStage57     = Input.OutputErrReLU2;
InstinctErrStage57   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage58Weights;
fxpWeights = WeightBias.fxpStage58Weights;
flpBias    = WeightBias.flpStage58Bias;
fxpBias    = WeightBias.fxpStage58Bias;
errWeights = WeightBias.errStage58Weights;
...
save('InputOutput\OutputStage58','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
