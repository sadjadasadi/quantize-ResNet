...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage81.mat');
shortcutInput= load('InputOutput\OutputStage79.mat');
WeightBias = load('WeightsBias\WeightBias82.mat');
...
OutputErrStage81     = Input.OutputErrReLU2;
InstinctErrStage81   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage82Weights;
fxpWeights = WeightBias.fxpStage82Weights;
flpBias    = WeightBias.flpStage82Bias;
fxpBias    = WeightBias.fxpStage82Bias;
errWeights = WeightBias.errStage82Weights;
...
save('InputOutput\OutputStage82','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
