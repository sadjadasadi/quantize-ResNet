...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage39.mat');
shortcutInput= load('InputOutput\OutputStage37.mat');
WeightBias = load('WeightsBias\WeightBias40.mat');
...
OutputErrStage39     = Input.OutputErrReLU2;
InstinctErrStage39   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage40Weights;
fxpWeights = WeightBias.fxpStage40Weights;
flpBias    = WeightBias.flpStage40Bias;
fxpBias    = WeightBias.fxpStage40Bias;
errWeights = WeightBias.errStage40Weights;
...
save('InputOutput\OutputStage40','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
