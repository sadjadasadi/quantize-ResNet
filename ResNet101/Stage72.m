...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage71.mat');
WeightBias = load('WeightsBias\WeightBias72.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage71    = Input.OutputErrReLU2;
InstinctErrStage71   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage72Weights;
fxpWeights = WeightBias.fxpStage72Weights;
flpBias    = WeightBias.flpStage72Bias;
fxpBias    = WeightBias.fxpStage72Bias;
errWeights = WeightBias.errStage72Weights;
...
save('InputOutput\OutputStage72','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
