...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage24.mat');
shortcutInput= load('InputOutput\OutputStage22.mat');
WeightBias = load('WeightsBias\WeightBias25.mat');
...
OutputErrStage24     = Input.OutputErrReLU2;
InstinctErrStage24   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage25Weights;
fxpWeights = WeightBias.fxpStage25Weights;
flpBias    = WeightBias.flpStage25Bias;
fxpBias    = WeightBias.fxpStage25Bias;
errWeights = WeightBias.errStage25Weights;
...
save('InputOutput\OutputStage25','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
