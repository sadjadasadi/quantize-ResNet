...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage90.mat');
shortcutInput= load('InputOutput\OutputStage88.mat');
WeightBias = load('WeightsBias\WeightBias91.mat');
...
OutputErrStage90    = Input.OutputErrReLU2;
InstinctErrStage90   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage91Weights;
fxpWeights = WeightBias.fxpStage91Weights;
flpBias    = WeightBias.flpStage91Bias;
fxpBias    = WeightBias.fxpStage91Bias;
errWeights = WeightBias.errStage91Weights;
...
save('InputOutput\OutputStage91','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
