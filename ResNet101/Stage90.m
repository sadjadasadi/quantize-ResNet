...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage89.mat');
WeightBias = load('WeightsBias\WeightBias90.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage89     = Input.OutputErrReLU2;
InstinctErrStage89   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage90Weights;
fxpWeights = WeightBias.fxpStage90Weights;
flpBias    = WeightBias.flpStage90Bias;
fxpBias    = WeightBias.fxpStage90Bias;
errWeights = WeightBias.errStage90Weights;
...
save('InputOutput\OutputStage90','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
