...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage54.mat');
shortcutInput= load('InputOutput\OutputStage52.mat');
WeightBias = load('WeightsBias\WeightBias55.mat');
...
OutputErrStage54     = Input.OutputErrReLU2;
InstinctErrStage54   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage55Weights;
fxpWeights = WeightBias.fxpStage55Weights;
flpBias    = WeightBias.flpStage55Bias;
fxpBias    = WeightBias.fxpStage55Bias;
errWeights = WeightBias.errStage55Weights;
...
save('InputOutput\OutputStage55','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
