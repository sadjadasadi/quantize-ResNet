...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage77.mat');
WeightBias = load('WeightsBias\WeightBias78.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage77     = Input.OutputErrReLU2;
InstinctErrStage77   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage78Weights;
fxpWeights = WeightBias.fxpStage78Weights;
flpBias    = WeightBias.flpStage78Bias;
fxpBias    = WeightBias.fxpStage78Bias;
errWeights = WeightBias.errStage78Weights;
...
save('InputOutput\OutputStage78','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
