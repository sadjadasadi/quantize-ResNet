...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage82.mat');
WeightBias = load('WeightsBias\WeightBias83.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage82     = Input.OutputErrReLU2;
InstinctErrStage82   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage83Weights;
fxpWeights = WeightBias.fxpStage83Weights;
flpBias    = WeightBias.flpStage83Bias;
fxpBias    = WeightBias.fxpStage83Bias;
errWeights = WeightBias.errStage83Weights;
...
save('InputOutput\OutputStage83','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
