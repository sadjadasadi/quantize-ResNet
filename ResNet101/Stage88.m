...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage87.mat');
shortcutInput= load('InputOutput\OutputStage85.mat');
WeightBias = load('WeightsBias\WeightBias88.mat');
...
OutputErrStage87     = Input.OutputErrReLU2;
InstinctErrStage87   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage88Weights;
fxpWeights = WeightBias.fxpStage88Weights;
flpBias    = WeightBias.flpStage88Bias;
fxpBias    = WeightBias.fxpStage88Bias;
errWeights = WeightBias.errStage88Weights;
...
save('InputOutput\OutputStage88','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
