...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage66.mat');
shortcutInput= load('InputOutput\OutputStage64.mat');
WeightBias = load('WeightsBias\WeightBias67.mat');
...
OutputErrStage66     = Input.OutputErrReLU2;
InstinctErrStage66   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage67Weights;
fxpWeights = WeightBias.fxpStage67Weights;
flpBias    = WeightBias.flpStage67Bias;
fxpBias    = WeightBias.fxpStage67Bias;
errWeights = WeightBias.errStage67Weights;
...
save('InputOutput\OutputStage67','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
