...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage44.mat');
WeightBias = load('WeightsBias\WeightBias45.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage44     = Input.OutputErrReLU2;
InstinctErrStage44   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage45Weights;
fxpWeights = WeightBias.fxpStage45Weights;
flpBias    = WeightBias.flpStage45Bias;
fxpBias    = WeightBias.fxpStage45Bias;
errWeights = WeightBias.errStage45Weights;
...
save('InputOutput\OutputStage45','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
