...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage80.mat');
WeightBias = load('WeightsBias\WeightBias81.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage80     = Input.OutputErrReLU2;
InstinctErrStage80   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage81Weights;
fxpWeights = WeightBias.fxpStage81Weights;
flpBias    = WeightBias.flpStage81Bias;
fxpBias    = WeightBias.fxpStage81Bias;
errWeights = WeightBias.errStage81Weights;
...
save('InputOutput\OutputStage81','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
