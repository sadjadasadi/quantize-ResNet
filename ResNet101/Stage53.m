...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage52.mat');
WeightBias = load('WeightsBias\WeightBias53.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage52     = Input.OutputErrReLU2;
InstinctErrStage52   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage53Weights;
fxpWeights = WeightBias.fxpStage53Weights;
flpBias    = WeightBias.flpStage53Bias;
fxpBias    = WeightBias.fxpStage53Bias;
errWeights = WeightBias.errStage53Weights;
...
save('InputOutput\OutputStage53','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
