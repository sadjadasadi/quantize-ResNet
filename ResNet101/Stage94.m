...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage93.mat');
shortcutInput= load('InputOutput\OutputStage91.mat');
WeightBias = load('WeightsBias\WeightBias94.mat');
...
OutputErrStage93     = Input.OutputErrReLU2;
InstinctErrStage93   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage94Weights;
fxpWeights = WeightBias.fxpStage94Weights;
flpBias    = WeightBias.flpStage94Bias;
fxpBias    = WeightBias.fxpStage94Bias;
errWeights = WeightBias.errStage94Weights;
...
save('InputOutput\OutputStage94','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
