...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage26.mat');
WeightBias = load('WeightsBias\WeightBias27.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage26     = Input.OutputErrReLU2;
InstinctErrStage26   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage27Weights;
fxpWeights = WeightBias.fxpStage27Weights;
flpBias    = WeightBias.flpStage27Bias;
fxpBias    = WeightBias.fxpStage27Bias;
errWeights = WeightBias.errStage27Weights;
...
save('InputOutput\OutputStage27','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
