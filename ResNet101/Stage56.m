...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage55.mat');
WeightBias = load('WeightsBias\WeightBias56.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage55     = Input.OutputErrReLU2;
InstinctErrStage55   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage56Weights;
fxpWeights = WeightBias.fxpStage56Weights;
flpBias    = WeightBias.flpStage56Bias;
fxpBias    = WeightBias.fxpStage56Bias;
errWeights = WeightBias.errStage56Weights;
...
save('InputOutput\OutputStage56','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
