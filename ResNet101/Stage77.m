...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage76.mat');
WeightBias = load('WeightsBias\WeightBias77.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage76     = Input.OutputErrReLU2;
InstinctErrStage76   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage77Weights;
fxpWeights = WeightBias.fxpStage77Weights;
flpBias    = WeightBias.flpStage77Bias;
fxpBias    = WeightBias.fxpStage77Bias;
errWeights = WeightBias.errStage77Weights;
...
save('InputOutput\OutputStage77','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
