...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage43.mat');
WeightBias = load('WeightsBias\WeightBias44.mat');
...
flpWeights = WeightBias.flpStage44Weights;
fxpWeights = WeightBias.fxpStage44Weights;
flpBias    = WeightBias.flpStage44Bias;
fxpBias    = WeightBias.fxpStage44Bias;
errWeights = WeightBias.errStage44Weights;
...
save('InputOutput\OutputStage44','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
