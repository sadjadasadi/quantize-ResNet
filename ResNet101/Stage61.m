...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage60.mat');
shortcutInput= load('InputOutput\OutputStage58.mat');
WeightBias = load('WeightsBias\WeightBias61.mat');
...
OutputErrStage60     = Input.OutputErrReLU2;
InstinctErrStage60   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage61Weights;
fxpWeights = WeightBias.fxpStage61Weights;
flpBias    = WeightBias.flpStage61Bias;
fxpBias    = WeightBias.fxpStage61Bias;
errWeights = WeightBias.errStage61Weights;
...
save('InputOutput\OutputStage61','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
