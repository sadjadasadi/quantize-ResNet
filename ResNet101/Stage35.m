...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage34.mat');
WeightBias = load('WeightsBias\WeightBias35.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage34     = Input.OutputErrReLU2;
InstinctErrStage34   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage35Weights;
fxpWeights = WeightBias.fxpStage35Weights;
flpBias    = WeightBias.flpStage35Bias;
fxpBias    = WeightBias.fxpStage35Bias;
errWeights = WeightBias.errStage35Weights;
...
save('InputOutput\OutputStage35','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
