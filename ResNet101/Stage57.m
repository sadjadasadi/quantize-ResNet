...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage56.mat');
WeightBias = load('WeightsBias\WeightBias57.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage56     = Input.OutputErrReLU2;
InstinctErrStage56   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage57Weights;
fxpWeights = WeightBias.fxpStage57Weights;
flpBias    = WeightBias.flpStage57Bias;
fxpBias    = WeightBias.fxpStage57Bias;
errWeights = WeightBias.errStage57Weights;
...
save('InputOutput\OutputStage57','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
