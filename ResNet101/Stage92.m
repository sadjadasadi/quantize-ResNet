...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage91.mat');
WeightBias = load('WeightsBias\WeightBias92.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage91    = Input.OutputErrReLU2;
InstinctErrStage91  = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage92Weights;
fxpWeights = WeightBias.fxpStage92Weights;
flpBias    = WeightBias.flpStage92Bias;
fxpBias    = WeightBias.fxpStage92Bias;
errWeights = WeightBias.errStage92Weights;
...
save('InputOutput\OutputStage92','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
