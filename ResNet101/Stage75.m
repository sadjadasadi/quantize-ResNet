...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage74.mat');
WeightBias = load('WeightsBias\WeightBias75.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage74    = Input.OutputErrReLU2;
InstinctErrStage74   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage75Weights;
fxpWeights = WeightBias.fxpStage75Weights;
flpBias    = WeightBias.flpStage75Bias;
fxpBias    = WeightBias.fxpStage75Bias;
errWeights = WeightBias.errStage75Weights;
...
save('InputOutput\OutputStage75','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
