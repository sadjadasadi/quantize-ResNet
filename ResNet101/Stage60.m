...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage59.mat');
WeightBias = load('WeightsBias\WeightBias60.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage59     = Input.OutputErrReLU2;
InstinctErrStage59   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage60Weights;
fxpWeights = WeightBias.fxpStage60Weights;
flpBias    = WeightBias.flpStage60Bias;
fxpBias    = WeightBias.fxpStage60Bias;
errWeights = WeightBias.errStage60Weights;
...
save('InputOutput\OutputStage60','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
