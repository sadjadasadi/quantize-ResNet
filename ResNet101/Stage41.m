...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage40.mat');
WeightBias = load('WeightsBias\WeightBias41.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage40     = Input.OutputErrReLU2;
InstinctErrStage40   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage41Weights;
fxpWeights = WeightBias.fxpStage41Weights;
flpBias    = WeightBias.flpStage41Bias;
fxpBias    = WeightBias.fxpStage41Bias;
errWeights = WeightBias.errStage41Weights;
...
save('InputOutput\OutputStage41','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
