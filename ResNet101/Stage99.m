...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage98.mat');
WeightBias = load('WeightsBias\WeightBias99.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage98     = Input.OutputErrReLU2;
InstinctErrStage98   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage99Weights;
fxpWeights = WeightBias.fxpStage99Weights;
flpBias    = WeightBias.flpStage99Bias;
fxpBias    = WeightBias.fxpStage99Bias;
errWeights = WeightBias.errStage99Weights;
...
save('InputOutput\OutputStage99','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
