...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage61.mat');
WeightBias = load('WeightsBias\WeightBias62.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage61     = Input.OutputErrReLU2;
InstinctErrStage61   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage62Weights;
fxpWeights = WeightBias.fxpStage62Weights;
flpBias    = WeightBias.flpStage62Bias;
fxpBias    = WeightBias.fxpStage62Bias;
errWeights = WeightBias.errStage62Weights;
...
save('InputOutput\OutputStage62','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
