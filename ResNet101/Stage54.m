...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage53.mat');
WeightBias = load('WeightsBias\WeightBias54.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStag53     = Input.OutputErrReLU2;
InstinctErrStage53   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage54Weights;
fxpWeights = WeightBias.fxpStage54Weights;
flpBias    = WeightBias.flpStage54Bias;
fxpBias    = WeightBias.fxpStage54Bias;
errWeights = WeightBias.errStage54Weights;
...
save('InputOutput\OutputStage54','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
