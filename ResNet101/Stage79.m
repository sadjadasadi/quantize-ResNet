...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage78.mat');
shortcutInput= load('InputOutput\OutputStage76.mat');
WeightBias = load('WeightsBias\WeightBias79.mat');
...
OutputErrStage78     = Input.OutputErrReLU2;
InstinctErrStage78   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage79Weights;
fxpWeights = WeightBias.fxpStage79Weights;
flpBias    = WeightBias.flpStage79Bias;
fxpBias    = WeightBias.fxpStage79Bias;
errWeights = WeightBias.errStage79Weights;
...
save('InputOutput\OutputStage79','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
