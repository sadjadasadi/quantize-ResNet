...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage88.mat');
WeightBias = load('WeightsBias\WeightBias89.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage88     = Input.OutputErrReLU2;
InstinctErrStage88   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage89Weights;
fxpWeights = WeightBias.fxpStage89Weights;
flpBias    = WeightBias.flpStage89Bias;
fxpBias    = WeightBias.fxpStage89Bias;
errWeights = WeightBias.errStage89Weights;
...
save('InputOutput\OutputStage89','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
