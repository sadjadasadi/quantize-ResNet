...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage92.mat');
WeightBias = load('WeightsBias\WeightBias93.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage92     = Input.OutputErrReLU2;
InstinctErrStage92   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage93Weights;
fxpWeights = WeightBias.fxpStage93Weights;
flpBias    = WeightBias.flpStage93Bias;
fxpBias    = WeightBias.fxpStage93Bias;
errWeights = WeightBias.errStage93Weights;
...
save('InputOutput\OutputStage93','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
