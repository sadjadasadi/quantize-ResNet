...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage69.mat');
shortcutInput= load('InputOutput\OutputStage67.mat');
WeightBias = load('WeightsBias\WeightBias70.mat');
...
OutputErrStage69     = Input.OutputErrReLU2;
InstinctErrStage69   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage70Weights;
fxpWeights = WeightBias.fxpStage70Weights;
flpBias    = WeightBias.flpStage70Bias;
fxpBias    = WeightBias.fxpStage70Bias;
errWeights = WeightBias.errStage70Weights;
...
save('InputOutput\OutputStage70','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
