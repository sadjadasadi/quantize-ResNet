...
WeightBias = load('WeightsBias\WeightBias18.mat');
...
flpWeights = WeightBias.flpStage18Weights;
fxpWeights = WeightBias.fxpStage18Weights;
flpBias    = WeightBias.flpStage18Bias;
fxpBias    = WeightBias.fxpStage18Bias;
errWeights = WeightBias.errStage18Weights;
...
save('InputOutput\OutputStage18','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
