...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage70.mat');
WeightBias = load('WeightsBias\WeightBias71.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage70     = Input.OutputErrReLU2;
InstinctErrStage70   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage71Weights;
fxpWeights = WeightBias.fxpStage71Weights;
flpBias    = WeightBias.flpStage71Bias;
fxpBias    = WeightBias.fxpStage71Bias;
errWeights = WeightBias.errStage71Weights;
...
save('InputOutput\OutputStage71','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
