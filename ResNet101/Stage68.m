...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage67.mat');
WeightBias = load('WeightsBias\WeightBias68.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage67     = Input.OutputErrReLU2;
InstinctErrStage67   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage68Weights;
fxpWeights = WeightBias.fxpStage68Weights;
flpBias    = WeightBias.flpStage68Bias;
fxpBias    = WeightBias.fxpStage68Bias;
errWeights = WeightBias.errStage68Weights;
...
save('InputOutput\OutputStage68','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
