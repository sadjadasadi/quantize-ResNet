...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage84.mat');
shortcutInput= load('InputOutput\OutputStage82.mat');
WeightBias = load('WeightsBias\WeightBias85.mat');
...
OutputErrStage84     = Input.OutputErrReLU2;
InstinctErrStage84   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage85Weights;
fxpWeights = WeightBias.fxpStage85Weights;
flpBias    = WeightBias.flpStage85Bias;
fxpBias    = WeightBias.fxpStage85Bias;
errWeights = WeightBias.errStage85Weights;
...
save('InputOutput\OutputStage85','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
