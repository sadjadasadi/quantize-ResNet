...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage65.mat');
WeightBias = load('WeightsBias\WeightBias66.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage65     = Input.OutputErrReLU2;
InstinctErrStage65   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage66Weights;
fxpWeights = WeightBias.fxpStage66Weights;
flpBias    = WeightBias.flpStage66Bias;
fxpBias    = WeightBias.fxpStage66Bias;
errWeights = WeightBias.errStage66Weights;
...
save('InputOutput\OutputStage66','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
