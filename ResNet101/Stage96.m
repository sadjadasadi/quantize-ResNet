...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage95.mat');
WeightBias = load('WeightsBias\WeightBias96.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage95     = Input.OutputErrReLU2;
InstinctErrStage95   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage96Weights;
fxpWeights = WeightBias.fxpStage96Weights;
flpBias    = WeightBias.flpStage96Bias;
fxpBias    = WeightBias.fxpStage96Bias;
errWeights = WeightBias.errStage96Weights;
...
save('InputOutput\OutputStage96','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
