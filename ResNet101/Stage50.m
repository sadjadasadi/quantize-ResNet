...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage49.mat');
WeightBias = load('WeightsBias\WeightBias50.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage49     = Input.OutputErrReLU2;
InstinctErrStage49   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage50Weights;
fxpWeights = WeightBias.fxpStage50Weights;
flpBias    = WeightBias.flpStage50Bias;
fxpBias    = WeightBias.fxpStage50Bias;
errWeights = WeightBias.errStage50Weights;
...
save('InputOutput\OutputStage50','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
