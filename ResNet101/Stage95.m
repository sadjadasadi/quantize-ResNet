...
clear all;
%% inputs------------------------------------------------------------------
Input      = load('InputOutput\OutputStage94.mat');
WeightBias = load('WeightsBias\WeightBias95.mat');

flpInput            = Input.flpOutputReLU; 
fxpInput            = Input.fxpOutputReLU2;
flpfxpInput         = Input.flpfxpfxpOutputReLU;
OutputErrStage94    = Input.OutputErrReLU2;
InstinctErrStage94  = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage95Weights;
fxpWeights = WeightBias.fxpStage95Weights;
flpBias    = WeightBias.flpStage95Bias;
fxpBias    = WeightBias.fxpStage95Bias;
errWeights = WeightBias.errStage95Weights;
...
save('InputOutput\OutputStage95','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
