...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage72.mat');
shortcutInput= load('InputOutput\OutputStage70.mat');
WeightBias = load('WeightsBias\WeightBias73.mat');
...
OutputErrStage72     = Input.OutputErrReLU2;
InstinctErrStage72   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage73Weights;
fxpWeights = WeightBias.fxpStage73Weights;
flpBias    = WeightBias.flpStage73Bias;
fxpBias    = WeightBias.fxpStage73Bias;
errWeights = WeightBias.errStage73Weights;
...
save('InputOutput\OutputStage73','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
