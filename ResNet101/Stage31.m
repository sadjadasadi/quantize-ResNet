...
clear all;
%% inputs------------------------------------------------------------------
Input= load('InputOutput\OutputStage30.mat');
shortcutInput= load('InputOutput\OutputStage28.mat');
WeightBias = load('WeightsBias\WeightBias31.mat');
...
OutputErrStage30     = Input.OutputErrReLU2;
InstinctErrStage30   = Input.InstinctErrReLU1;

flpWeights = WeightBias.flpStage31Weights;
fxpWeights = WeightBias.fxpStage31Weights;
flpBias    = WeightBias.flpStage31Bias;
fxpBias    = WeightBias.fxpStage31Bias;
errWeights = WeightBias.errStage31Weights;
...
save('InputOutput\OutputStage31','flpOutputReLU','fxpOutputReLU2','flpfxpfxpOutputReLU','OutputErrReLU2','InstinctErrReLU1');
